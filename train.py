...
HTB Machine Learning Security Challenge
"""
...
def main():
    ...
    # Data normalization (must match server exactly)
    ...
    print("="*60)
    print("\nNext step: Submit model to server")
    print('  curl -X POST "$BASE_URL/submit" -F "defended_model=@defended_model.safetensors"')
